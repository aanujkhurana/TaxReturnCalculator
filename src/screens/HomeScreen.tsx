...
// Type definitions for HomeScreen props
...
const HomeScreen: React.FC<HomeScreenProps> = ({ onCreateNew, onViewCalculation, onNavigate }) => {
  ...
  const loadSavedCalculations = async (): Promise<void> => {
    try {
        ...
        <View style={styles.cardHeader}>
          <View style={styles.cardTitleContainer}>
            ...
            <View style={styles.cardTitleTextContainer}>
              ...
              <Text style={styles.cardSubtitle}>Financial Year 2025-26</Text>
            </View>
          </View>
          <TouchableOpacity
        ...
        <View style={styles.cardContent}>
          <View style={styles.cardFinancialSummary}>
            <View style={styles.cardSummaryItem}>
              ...
              <Text style={styles.cardSummaryValue}>${formatCurrency(totalIncome)}</Text>
            </View>
            <View style={styles.cardSummaryDivider} />
            <View style={styles.cardSummaryItem}>
              <Text style={styles.cardSummaryLabel}>Tax Payable</Text>
              <Text style={styles.cardSummaryValue}>${formatCurrency(totalTax)}</Text>
            </View>
          </View>
          ...
          <View style={[styles.cardRefundSection, { backgroundColor: statusColor + '10' }]}>
            <View style={styles.cardRefundHeader}>
              <Ionicons
                ...
                color={statusColor}
              />
              <Text style={[styles.cardRefundLabel, { color: statusColor }]}>{statusText}</Text>
            </View>
  ...
  return (
    <View style={styles.container}>
          ...
          <View style={styles.calculationsContainer}>
            <View style={styles.calculationsHeader}>
              ...
              <Text style={styles.calculationsSubtitle}>
                {savedCalculations.length} saved calculation
          ...
          {isResourcesExpanded && (
            <View style={styles.resourcesGrid}>
              ...
              <TouchableOpacity
                ...
                onPress={() =>
                  openExternalURL('https://www.ato.gov.au/individuals/lodging-your-tax-return/')
                }
              >
                <View style={styles.resourceButtonIconContainer}>
      ...
      <View style={styles.bottomActionContainer}>
        <TouchableOpacity style={styles.createNewButton} onPress={onCreateNew} activeOpacity={0.8}>
          <LinearGradient
