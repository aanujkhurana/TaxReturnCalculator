 ...
 * @param {string} calculationName - Name of the calculation
 * @returns {string} - HTML content for the PDF
 */
const generateHTMLContent = (calculationData, calculationName) => {
 ...
 */
export const generateAndSharePDF = async (calculationData, calculationName = 'Tax Calculation') => {
  try {
