    ...
    <body>
        ...
        <div class="footer">
            ...
            <div class="disclaimer">
                <strong>Disclaimer:</strong> This calculation is an estimate only and should not be considered registered tax agent advice. 
                Please consult a registered tax agent or use official ATO services for your actual tax return.
            </div>
        </div>
    </body>
    </html>
