    ...
    try {
      ...
      const htmlContent = `
        ...
        <body>
          ...
          <div class="footer">
            <p>This is an estimate only. Please consult a registered tax agent or use official ATO services for your actual tax return.</p>
      ...
      <View style={styles.tabContent}>
        ...
        <View style={styles.warningCard}>
          ...
          <Text style={styles.warningCardText}>
            ...
            estimates only and should not replace advice from a registered tax agent.
          </Text>
        </View>
