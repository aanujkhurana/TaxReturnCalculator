...
export const HELP_TEXT: HelpTextData = {
  jobIncome: {
    ...
    purpose:
      'Enter your gross annual salary or wages from employment where tax was withheld using your Tax File Number (TFN).',
    examples: [
  ...
  abnIncome: {
    ...
    purpose:
      'Enter your total income from self-employment, contracting, or business activities using your Australian Business Number (ABN).',
    examples: [
  ...
  taxWithheld: {
    ...
    purpose:
      'Enter the total amount of tax that was withheld from your employment income (TFN jobs) during the financial year.',
    examples: [
  ...
  workRelated: {
    ...
    purpose:
      "Enter the total amount you spent on items required for your work that weren't reimbursed by your employer.",
    examples: ['Tools and equipment: 800', 'Work uniforms: 300', 'Professional development: 1200'],
    tips: [
  ...
  selfEducation: {
    ...
    purpose:
      'Enter costs for courses, training, or education that directly relates to your current job or increases your income-earning ability.',
    examples: [
  ...
  otherDeductions: {
    ...
    purpose:
      'Enter other allowable tax deductions such as investment expenses, tax agent fees, or income protection insurance.',
    examples: [
      'Tax agent fees: 300',
  ...
  workFromHome: {
    ...
    purpose:
      'Enter the total number of hours you worked from home during the financial year using the ATO shortcut method.',
    examples: [
  ...
  dependents: {
    ...
    purpose:
      'Enter the number of dependent children or other dependents that may affect your tax offsets and Medicare levy.',
    examples: ['Two children under 18: 2', 'One child + elderly parent: 2', 'No dependents: 0'],
    tips: [
  ...
  hecsDebt: {
    ...
    purpose:
      'Indicate if you have outstanding Higher Education Contribution Scheme (HECS) or Higher Education Loan Programme (HELP) debt.',
    examples: [
  ...
  workRelatedTravel: {
    ...
    purpose:
      'Enter costs for travel directly related to your work, excluding normal commuting between home and work.',
    examples: [
  ...
  workRelatedEquipment: {
    ...
    purpose:
      "Enter costs for tools, equipment, and technology required for your work that weren't provided by your employer.",
    examples: ['Professional tools: 600', 'Computer equipment: 1200', 'Safety equipment: 300'],
    tips: [
  ...
  workRelatedUniforms: {
    ...
    purpose:
      'Enter costs for compulsory work uniforms, protective clothing, and occupation-specific clothing.',
    examples: ['Company uniform: 250', 'Safety boots and gear: 180', 'Professional attire: 400'],
    tips: [
  ...
  workRelatedMemberships: {
    ...
    purpose:
      'Enter costs for professional memberships, union fees, and work-related subscriptions.',
    examples: [
