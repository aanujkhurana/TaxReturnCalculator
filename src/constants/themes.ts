...
export interface Theme {
  ...
  // Button colors
  buttonNext: string;
  buttonNextBorder: string;
  buttonBack: string;
  buttonBackBorder: string;
  buttonCalculate: string;
  buttonCalculateBorder: string;
  ...
  // Category colors
  categoryWork: string;
  categoryWorkLight: string;
  categoryEducation: string;
  categoryEducationLight: string;
  categoryDonations: string;
  categoryDonationsLight: string;
  categoryOther: string;
  categoryOtherLight: string;
  categoryHome: string;
  categoryHomeLight: string;
  categoryPink: string;
  categoryPinkLight: string;

  // ATO colors
  atoBlue: string;
  atoBlueBorder: string;
}
...
// Theme storage key
export const THEME_STORAGE_KEY: string = 'app_theme_preference' as const;
